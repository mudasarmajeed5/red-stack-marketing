    ...
    return (<div className="container bg-black text-white px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto mb-16">
            ...
            <div className="flex flex-col items-center text-center group p-8 rounded-lg shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                <div className="w-24 h-24 rounded-lg bg-black p-6 mb-6 group-hover:bg-red-600 transition-colors">
                    <Palette className="w-full h-full text-white" />
                </div>
                <Link href={"/creative"}><h3 className="text-xl font-bold text-white">CREATIVE</h3></Link>
            </div>
            ...
            <div className="flex flex-col items-center text-center group p-8 rounded-lg shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                ...
                <Link href={"/digital"}><h3 className="text-xl font-bold text-white">DIGITAL</h3></Link>
            </div>
            ...
            <div className="flex flex-col items-center text-center group p-8 rounded-lg shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                ...
                <Link href={"/events"}><h3 className="text-xl font-bold text-white">EVENTS & ACTIVATION</h3></Link>
            </div>
        </div>

        {/* Portfolio Button */}
        <div className="text-center">
            <button className="px-8 py-3 bg-red-600 text-white border rounded-full hover:bg-black transition-colors">
                PORTFOLIO
            </button>
        </div>
    </div>

    ...
    <>
      <div id="home" className="FirstPage relative">
        <div className="img">
          ...
          {/* <video src="https://reinvention.vercel.app/EventVideo.mp4" autoPlay muted loop className="object-cover object-center absolute w-full h-full "></video> */}
        </div>
        <div className="text_anime flex justify-center items-center h-[80vh] flex-col relative">
          <TextAnimation />
          <div className="flex gap-2">
            <button className='text-white backdrop:blur-sm mt-20 bg-yellow-600 text-xl rounded-md hover:bg-yellow-700 animate-bounce px-3 py-1'><Link href="#services">Explore Services</Link></button>
          </div>
